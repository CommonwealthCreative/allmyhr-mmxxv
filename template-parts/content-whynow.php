<?php
/**
 * Template part for displaying FAQ's Section
 *
...
<h2 class="center">New 2026 Regulations Are <span class="highlight txt">Now in Effect</span></h2> 
                  <p class="">Minimum wage changes, overtime rules, and new training requirements are active across multiple states.
ARIES AI / HR AI + AllMyHR keeps you compliant automatically.</p>
                ...
                <div>
                  <div class="card lite">
                    <div class="w-layout-hflex phrases"><img src="/wp-content/themes/allmyhr-mmxxv/images/real-answer.webp" loading="lazy" alt="" class="headlineicon">
                      <h3>ARIES™, Your Human-backed AI HR Assistant</h3>
                    </div>
                    <div class="crumb hr">Your unified AI ecosystem, orchestrates intelligence across legal, compliance, and HR. It brings together autonomous agents, digital assistants, and AI capabilities to transform how work gets done.</div>
                    <div class="w-layout-hflex bullet">
                      <div class="crumb"><span class="fa highlight blu txt"></span></div>
                      <h4 class="crumb">Humans in the Loop: Experts guide the prompting, training, evaluation, and design of ARIES™</h4>
                    </div>
                    <div class="w-layout-hflex bullet">
                      <div class="crumb"><span class="fa highlight blu txt"></span></div>
                      <h4 class="crumb">Customer Collaboration: Co-development alongside customer working groups to create, test, and verify use cases</h4>
                    </div>
                    <div class="w-layout-hflex bullet">
                      <div class="crumb"><span class="fa highlight blu txt"></span></div>
                      <h4 class="crumb">Trusted Data: Combine rich data with expert insight, ensuring every AI response is from reliable, trustworthy information.</h4>
                    </div>
                  </div>
                </div>
              </div>
