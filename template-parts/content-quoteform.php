<?php
/**
 * Template part for displaying Quote Form Section
 *
...
<div class="container">
      <div class="container h-content center">
        <h2 class="center">Are HR challenges slowing down you business?</h2>
        <p>Get a custom quote tailored to your needs or see our solutions in action with a personalized demonstration. <span class="highlight  txt">Let’s find the right fit for all of your HR requirements.</span></p>
      </div>
